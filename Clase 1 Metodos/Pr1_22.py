# -*- coding: utf-8 -*-
""" 
* MÉTODOS NUMÉRICOS Y COMPUTACIÓN * 2020/2021 * GRADO EN FÍSICA *
...
# Sin embargo, ni las listas ni las tuplas son adecuadas para trabajar con arreglos de números
# conservando, de alguna manera, las operaciones de Rn. Los arrays son objetos propios de la librería
# numpy. Existen varias formas de definir arreglos, e.g. array, arange, linspace, entre otras.
...
P1=np.array([3,-2,1]) # En potencias decrecientes.
Q1=np.array([2,1])
...
# Usando arreglos de números (arrays) podemos elaborar gráficas:
